    ...
    <table class="tablefile" rules=rows cellspacing="0" frame="box" width="95%" style="margin: auto" >
        ...
        <c:forEach var="temp" items="${requestScope.List}"
            ...
            <tr style="line-height: 40px;">
                ...
                <td>
                    <a href="${pageContext.request.contextPath}/upload_log_delete.action?download_user_name=${temp.download_user_name}&download_file_name=${temp.download_file_name}"
